...
Pante is a DEX-style app on Arc Testnet. It supports USDC transfers, PANTE token transfers, payment link generation, and displays live balances. The PANTE token is a custom ERC-20 with fee-on-transfer, staking integration, EIP-2612 Permit, AccessControl, and EIP-1363 transferAndCall.

## Deployed Contracts

| Contract | Chain | Address | Explorer |
|---|---|---|---|
| PanteToken | Arc Testnet | `0xda447c6800004fd7f46921f7a6a0fceb8e96d1cc` | https://explorer.testnet.arc.io/address/0xda447c6800004fd7f46921f7a6a0fceb8e96d1cc |

Contract source: `contracts/PanteToken.sol`
Contract config (ABI + address): `src/contracts/PanteToken.ts`
