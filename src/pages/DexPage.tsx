...
const TABS: { id: Tab; label: string; icon: React.ReactNode; url: string }[] = [
  { id: 'buy',  label: 'Launchpad', icon: <ShoppingCart size={12} />, url: SYNTHRA_LAUNCHPAD_URL },
  { id: 'swap', label: 'Swap',      icon: <TrendingUp   size={12} />, url: SYNTHRA_SWAP_URL },
  { id: 'pool', label: 'Liquidity', icon: <Droplets     size={12} />, url: SYNTHRA_POOL_URL },
]
